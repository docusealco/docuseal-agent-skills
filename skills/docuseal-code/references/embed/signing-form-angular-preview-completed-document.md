...
Set to `true` to display the document in read-only preview mode without the submit button.

#### [token]

A [JWT token](signing-form-angular.md) is required to authenticate the preview of completed documents.
